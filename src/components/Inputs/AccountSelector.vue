<template>
	<div class="account-selector">
		<div class="account-display" @click="store.show_login_dropdown = !store.show_login_dropdown">
			...
			<div class="account-wrapper" data-test-id="currentUser">{{ store.selected_account || 'No Connection' }}</div>
		...
		<div class="account-dropdown" v-if="store.show_login_dropdown">
			<h6 class="text-left" v-if="store.selected_account"
			...
			<div class="accounts" v-if="store.accounts.length">
				<div v-for="account in store.accounts"
						 ...
						 class="account"
						 :class="{ active: account === store.selected_account}">
					<div>
			...
			<button class="near-login" @click="store.trigger_wallet_signin = !store.trigger_wallet_signin"
...
export default {
	...
	methods: {
		updateSelectedAccount(account){
			this.store.selected_account = account
